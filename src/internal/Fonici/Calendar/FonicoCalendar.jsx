...
export const Calendar = ({ isAdmin, fonico }) => {
    const { fonici, prenotazioni, setDisponibilita, setNonDisponibilita, setDisponibilita2 } = usePrenotazioni();
    ...
    const getCellColor = (code) => {
        ...
        if (editingDisponibilita) {
            return selectedDisponibilita.includes(code) ? 'green' : 'white';
        } else if (selectedDisponibilita.includes(code)) {
            return 'green';
        } else {
            return 'white'
        }
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                backgroundColor: selectedDisponibilita.includes(code) ? 'green' : 'white',
                                                display: "flex",
                                                flexDirection: "row",
    ...
    return (
        <div>
            ...
            {
                isAdmin ?
                    (!editingDisponibilita && selectedFonico != 1 &&
